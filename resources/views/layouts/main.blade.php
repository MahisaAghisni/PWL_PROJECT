...
<body>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('template/assets/images/faces/face2.jpg') }}"
                                                            alt="image" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('template/assets/images/faces/face5.jpg') }}"
                                                            alt="image" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('template/assets/images/faces/face3.jpg') }}"
                                                            alt="image" />
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="preview-list">
                                        <div class="preview-item border-bottom">
                                            <div class="preview-thumbnail">
                                                <img src="{{ asset('template/assets/images/faces/face6.jpg') }}"
                                        ...
                                        <div class="preview-item border-bottom">
                                            <div class="preview-thumbnail">
                                                <img src="{{ asset('template/assets/images/faces/face8.jpg') }}"
                                                    alt="image" class="rounded-circle" />
                                            </div>
                                            <div class="preview-item-content d-flex flex-grow">
                                                <div class="flex-grow">
                                        ...
                                        <div class="preview-item border-bottom">
                                            <div class="preview-thumbnail">
                                                <img src="{{ asset('template/assets/images/faces/face9.jpg') }}"
                                                    alt="image" class="rounded-circle" />
                                            </div>
                                            <div class="preview-item-content d-flex flex-grow">
                                                <div class="flex-grow">
                                        ...
                                        <div class="preview-item border-bottom">
                                            <div class="preview-thumbnail">
                                                <img src="{{ asset('template/assets/images/faces/face11.jpg') }}"
                                                    alt="image" class="rounded-circle" />
                                            </div>
                                            <div class="preview-item-content d-flex flex-grow">
                                                <div class="flex-grow">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel"
                                        ...
                                        <div class="item">
                                            <img src="{{ asset('template/assets/images/dashboard/Rectangle.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="item">
                                            <img src="{{ asset('template/assets/images/dashboard/Img_5.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="item">
                                            <img src="{{ asset('template/assets/images/dashboard/img_6.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
    ...
    <script src="{{ asset('template/assets/vendors/chart.js/Chart.min.j') }}s"></script>
